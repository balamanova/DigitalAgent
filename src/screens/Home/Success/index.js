    ...
    return (
      <ScrollView style={constStyles.container}>
        <View style={constStyles.mainContainer}>
          <View>
            <Text style={constStyles.typeText}>Статус жалобы</Text>
            <BaseTextWithIcon text={'Обработан'} src={imageLink['success']} />
          </View>

          <InfoTypeText type={'Дата и время'} text={'12 Марта 2019, 10:41'} textBlackColoured={true} />
          <View>
            <Text style={constStyles.typeText}>Обработал</Text>
            <AvatarViewWithName />
          </View>
